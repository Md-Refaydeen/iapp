...
const Color BGcolor=Color(0xFFDED2EB);
const Color btnColor=Color(0xFF5278FF);
const Color attendance=Color(0xFF7C4CAC);

const String emailPattern =
    r'^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$';

Color primaryColor=const Color(0XDED2EB);
